...
(function () {
    ...
    function supertriangle(vertices) {
        var xmin = Number.POSITIVE_INFINITY, ymin = Number.POSITIVE_INFINITY, xmax = Number.NEGATIVE_INFINITY,
            ymax = Number.NEGATIVE_INFINITY, i, dx, dy, dmax, xmid, ymid;
    ...
    function circumcircle(vertices, i, j, k) {
        var x1 = vertices[i][0], y1 = vertices[i][1], x2 = vertices[j][0], y2 = vertices[j][1], x3 = vertices[k][0],
            y3 = vertices[k][1], fabsy1y2 = Math.abs(y1 - y2), fabsy2y3 = Math.abs(y2 - y3), xc, yc, m1, m2, mx1, mx2,
            my1, my2, dx, dy;
 ...
 * building a list of triplets that represent triangles. */
            ...
            var a = tri[1][0] - tri[0][0], b = tri[2][0] - tri[0][0], c = tri[1][1] - tri[0][1],
                d = tri[2][1] - tri[0][1], i = a * d - b * c;
...
FSS.WebGLRenderer.prototype.render = function (scene) {
    ...
    var m, mesh, t, tl, triangle, l, light, attribute, uniform, buffer, data, location, update = false,
        lights = scene.lights.length, index, v, vl, vetex, vertices = 0;
...
(function () {
    ...
    var MESH = {
        width: 1.2, height: 1.2, slices: 150, ambient: '#555555', diffuse: '#FFFFFF'
    };
        ...
        exportCurrent: function () {
            switch (RENDER.renderer) {
                ...
                case CANVAS:
                    ...
                    break;
                case SVG:
                    var data = encodeURIComponent(container.innerHTML);
    ...
    function changeColors() {
        // Supposons que vous avez accès aux objets de maillage et de lumière
        mesh.material.ambient.set(LIGHT.ambient);
        mesh.material.diffuse.set(LIGHT.diffuse);
